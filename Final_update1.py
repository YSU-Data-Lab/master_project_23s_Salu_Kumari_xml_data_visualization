...
try:
    ...
    if connSqlServer.is_connected():
        ...
        sql = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES  WHERE TABLE_SCHEMA = 'Final' AND TABLE_NAME = '{}'"
...
#Award Table 
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS award (AwardTitle VARCHAR(255),AGENCY VARCHAR(255),AwardEffectiveDate VARCHAR(255),AwardExpirationDate VARCHAR(255), \
            AwardTotalIntnAmount VARCHAR(255),AwardAmount BIGINT, AbstractNarration TEXT , MinAmdLetterDate varchar(255), MaxAmdLetterDate varchar(255),CFDA_NUM VARCHAR(255), \
            NSF_PAR_USE_FLAG BIGINT, FUND_AGCY_CODE BIGINT, AWDG_AGCY_CODE BIGINT, FUND_OBLG VARCHAR(255), AwardID BIGINT UNIQUE PRIMARY KEY,INDEX idx_award_id (AwardID))") 
...
#Program_officer table 
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS program_officer (SignBlockName VARCHAR(255),PO_EMAI VARCHAR(255),PO_PHON VARCHAR(255), \
            AwardID BIGINT, FOREIGN KEY(AwardID) REFERENCES award(AwardID),INDEX idx_Program_officer_award_id (AwardID))")
...
#-------------------------------------
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS investigator (FirstName VARCHAR(255), LastName VARCHAR(255), PI_MID_INIT VARCHAR(255), \
            PI_SUFX_NAME VARCHAR(255),PI_FULL_NAME VARCHAR(255),EmailAddress VARCHAR(255), NSF_ID VARCHAR(255), StartDate VARCHAR(255), \
            EndDate VARCHAR(255), RoleCode VARCHAR(255), FirstName2 VARCHAR(255), LastName2 VARCHAR(255), PI_MID_INIT2 VARCHAR(255), \
            PI_SUFX_NAME2 VARCHAR(255),PI_FULL_NAME2 VARCHAR(255),EmailAddress2 VARCHAR(255),NSF_ID2 VARCHAR(255), StartDate2 VARCHAR(255), \
            EndDate2 VARCHAR(255), RoleCode2 VARCHAR(255), AwardID BIGINT, FOREIGN KEY(AwardID) REFERENCES award(AwardID),INDEX idx_investigator_award_id (AwardID))")  
...
#Institution table 
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS institution (Name VARCHAR(255),CityName VARCHAR(255),ZipCode VARCHAR(255),PhoneNumber BIGINT,\
            StreetAddress VARCHAR(255),StreetAddress2 VARCHAR(255), CountryName VARCHAR(255),StateName VARCHAR(255),StateCode VARCHAR(255), \
            CONGRESSDISTRICT BIGINT,CONGRESS_DISTRICT_ORG VARCHAR(255),ORG_UEI_NUM VARCHAR(255), ORG_LGL_BUS_NAME VARCHAR(255),ORG_PRNT_UEI_NUM VARCHAR(255), \
            AwardID BIGINT,FOREIGN KEY(AwardID) REFERENCES award(AwardID), INDEX idx_institution_award_id (AwardID))")  
...
#Performance_institution table    
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS performance_institution (Name VARCHAR(255),CityName VARCHAR(255),StateCode VARCHAR(255), \
            ZipCode VARCHAR(255),StreetAddress VARCHAR(255),CountryCode VARCHAR(255),CountryName VARCHAR(255),StateName VARCHAR(255),CountryFlag VARCHAR(255), \
            CONGRESSDISTRICT VARCHAR(255),CONGRESS_DISTRICT_PERF VARCHAR(255), AwardID BIGINT, FOREIGN KEY(AwardID) REFERENCES award(AwardID),INDEX idx_performance_institution_award_id (AwardID))")   
...
#Award_institution table 
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE award_institution (AwardID BIGINT,Name VARCHAR(255),CityName VARCHAR(255), StateName VARCHAR(255), ORG_UEI_NUM VARCHAR(255), \
            ORG_LGL_BUS_NAME VARCHAR(255), FOREIGN KEY(AwardID) REFERENCES award(AwardID), INDEX idx_award_institution_award_id (AwardID))")
...
#Award_investigator table 
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS award_investigator (AwardID BIGINT, FirstName VARCHAR(255), LastName VARCHAR(255), PI_MID_INIT VARCHAR(255), \
            PI_SUFX_NAME VARCHAR(255),PI_FULL_NAME VARCHAR(255),EmailAddress VARCHAR(255), NSF_ID VARCHAR(255), StartDate VARCHAR(255),EndDate VARCHAR(255), RoleCode VARCHAR(255), FirstName2 VARCHAR(255), LastName2 VARCHAR(255), PI_MID_INIT2 VARCHAR(255), PI_SUFX_NAME2 VARCHAR(255),PI_FULL_NAME2 VARCHAR(255),EmailAddress2 VARCHAR(255),NSF_ID2 VARCHAR(255), StartDate2 VARCHAR(255), EndDate2 VARCHAR(255), RoleCode2 VARCHAR(255),FOREIGN KEY(AwardID) REFERENCES award(AwardID), INDEX idx_award_investigator_award_id (AwardID))")
...
#Award_performance_institution table
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS award_performance_institution (AwardID BIGINT, Name VARCHAR(225),CityName VARCHAR(225), \
            StateName VARCHAR(225), FOREIGN KEY(AwardID) REFERENCES award(AwardID), INDEX idx_award_performance_institution_award_id (AwardID))")
...
#info
        ...
        if table_exists:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS info (AwardID BIGINT, MinAmdLetterDate varchar(255),MaxAmdLetterDate varchar(255), \
            AwardEffectiveDate VARCHAR(255), AwardExpirationDate VARCHAR(255),AwardTotalIntnAmount VARCHAR(255), AwardAmount BIGINT, AbstractNarration TEXT, \
            First_Investigator VARCHAR(255), Second_Investigator VARCHAR(255), SignBlockName VARCHAR(255), Name VARCHAR(255) ,FOREIGN KEY(AwardID) REFERENCES award(AwardID), INDEX idx_info_award_id (AwardID))")
            print("Info Table created ")                 
#------------------------------------- 
#setting path
        path = '/Users/salukayastha/Desktop/Final/xml/'
...
#-------------------------------------
                for award in root.findall('Award'):
                    ...
                    if award_abstract_narration is not None:
                        award_abstract_narration = remove_tags(award_abstract_narration)
                        sentences = award_abstract_narration.split('. ')    
                    ...
                    fund_oblg_elem = award.find('FUND_OBLG')
                    if fund_oblg_elem is not None:
                        fund_oblg = fund_oblg_elem.text
                    else:
                        fund_oblg = None  
...
# Check if the award instrument already exists and works for duplicate data                    
                    ...
                    if result and result[0]:
                        ...
                        try:
                            cursor.execute('INSERT INTO award (AwardTitle,AGENCY,AwardEffectiveDate,AwardExpirationDate,AwardTotalIntnAmount,AwardAmount, \
                            AbstractNarration,MinAmdLetterDate,MaxAmdLetterDate,CFDA_NUM,NSF_PAR_USE_FLAG,FUND_AGCY_CODE,AWDG_AGCY_CODE,FUND_OBLG,AwardID) \
                            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )', (award_title, award_agency, award_effectivedate, award_expirationdate, \
                            award_total_amount,award_amount, award_abstract_narration, award_min_amd_ldate, award_max_amd_ldate, cfda_num, nsf_par_use_flag, \
                            fund_agcy_code, awdg_agcy_code, fund_oblg, award_id)) #fund_oblg
...
#Check if the award program_officer already exists and works for duplicate data
                    ...
                    if result:
                        ...
                        try:
                            cursor.execute('INSERT INTO program_officer (SignBlockName, PO_EMAI, PO_PHON, AwardID) VALUES (%s, %s,%s, %s)', \
                            (sign_block_name,po_email,po_phone, award_id))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue
...
#------------------------------------- 
            ...
            # Insert both Investigator elements into the database
                            cursor.execute('INSERT INTO investigator (FirstName,LastName,PI_MID_INIT,PI_SUFX_NAME,PI_FULL_NAME,EmailAddress,NSF_ID,StartDate,\
                            EndDate,RoleCode, FirstName2 ,LastName2 , PI_MID_INIT2 , PI_SUFX_NAME2, PI_FULL_NAME2, EmailAddress2 , NSF_ID2 , StartDate2 , EndDate2, RoleCode2, AwardID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', 
                                       (fname, lname, pi_mid_init, pi_sufx, pi_full_name, email, nsf_id, start_date, end_date, role_code, fname2, lname2, \
                                        pi_mid_init2, pi_sufx2, pi_full_name2, email2, nsf_id2, start_date2, end_date2, role_code2, award_id))
                        except AttributeError:
            
                 
            # Handle the case where there is no second Investigator element
                            cursor.execute('INSERT INTO investigator (FirstName,LastName,PI_MID_INIT,PI_SUFX_NAME,PI_FULL_NAME,EmailAddress,NSF_ID,StartDate, \
                            EndDate,RoleCode, AwardID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',
...
# Check if the award investigator already exists and works for duplicate data
                for investigator, investigator2 in zip(award.findall('Investigator'), award.findall('Investigator')[1:] + [None]):
                    ...
                    if result:
                        ...
                        try:
                            ...
                            cursor.execute('INSERT INTO award_investigator (AwardID,FirstName,LastName,PI_MID_INIT,PI_SUFX_NAME,PI_FULL_NAME,EmailAddress, \
                            NSF_ID,StartDate,EndDate,RoleCode, FirstName2 ,LastName2 , PI_MID_INIT2 , PI_SUFX_NAME2, PI_FULL_NAME2, EmailAddress2 , NSF_ID2 , \
                            StartDate2 , EndDate2, RoleCode2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', 
            ...
            # Handle the case where there is no second award Investigator element
                            cursor.execute('INSERT INTO award_investigator (AwardID,FirstName,LastName,PI_MID_INIT,PI_SUFX_NAME,PI_FULL_NAME,EmailAddress, \
                            NSF_ID,StartDate,EndDate,RoleCode ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',
...
# Check if the  institution already exists and works for duplicate data                       
                    ...
                    if result:
                        ...
                        try:
                            cursor.execute('INSERT INTO institution (Name,CityName,ZipCode,PhoneNumber,StreetAddress,StreetAddress2,CountryName,StateName, \
                            StateCode,CONGRESSDISTRICT,CONGRESS_DISTRICT_ORG,ORG_UEI_NUM,ORG_LGL_BUS_NAME,ORG_PRNT_UEI_NUM,AwardID) VALUES \
                            (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', (name,city,zip_code,phone_num,add,add2,country_name,state_name, \
                            state_code,congressdist,congress_dist_org,org_uei,org_lgl,org_prnt, award_id))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue
# Check if the award award_institution already exists and works for duplicate data
                    ...
                    if result:
                        ...
                        try:
                            cursor.execute('INSERT INTO award_institution (AwardID, Name, CityName, StateName, ORG_UEI_NUM, ORG_LGL_BUS_NAME) \
                            VALUES (%s, %s, %s, %s, %s, %s)', (award_id, name, city, state_name, org_uei, org_lgl ))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue                       
#-------------------------------------
...
# Check if the award performance_institution already exists and works for duplicate data
                    ...
                    if result:
                        ...
                        try:
                            cursor.execute('INSERT INTO performance_institution (Name, CityName, StateCode, ZipCode, StreetAddress, CountryCode, \
                            CountryName, StateName, CountryFlag, CONGRESSDISTRICT, CONGRESS_DISTRICT_PERF, AwardID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', (name, city_name, state_code, zip_code, stress_address, country_code, country_name, state_name, country_flag, congress_district, congress_district_perf, award_id))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue
#Check if the award award_performance_institution already exists and works for duplicate data
                        
                    cursor.execute("SELECT 1 FROM award_performance_institution USE INDEX (idx_award_performance_institution_award_id) \
                    LEFT JOIN performance_institution USE INDEX (idx_performance_institution_award_id) ON award_performance_institution.AwardID = performance_institution.AwardID \
                    WHERE award_performance_institution.AwardID = %s LIMIT 1", (award_id,))
                    ...
                    if result:
                        ...
                        try:
                            cursor.execute('INSERT INTO award_performance_institution (AwardID, Name, CityName, StateName) VALUES (%s, %s, %s, %s)', \
                            (award_id,name,city_name,state_name))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue
...
# Check if the award program_element already exists and works for duplicate data                       
                    ...
                    cursor.execute("SELECT 1 FROM award_program_element USE INDEX (idx_award_program_element_award_id) \
                    WHERE award_program_element.AwardID = %s LIMIT 1", (award_id,))
                    result = cursor.fetchone()
                    if result:
                        print(f"AwardID {award_id} already exists in award_program_element table. Skipping update on table...")
                    else:
                        try:
                            cursor.execute('INSERT INTO award_program_element (AwardID, Code, Text) SELECT award.AwardID, program_element.Code, \
                            program_element.Text FROM award LEFT JOIN program_element ON program_element.AwardID = award.AwardID WHERE award.AwardID = %s', (award_id,))
                        except mysql.connector.IntegrityError:
                            print(f"Skipping duplicate record with AwardID {award_id}")
                            continue  
...
# Check if the award award_program_reference already exists and works for duplicate data
                        ...
                        cursor.execute("SELECT 1 FROM award_program_reference USE INDEX (idx_award_program_reference_award_id) LEFT JOIN \
                        program_reference USE INDEX (idx_program_reference_award_id) ON award_program_reference.AwardID = program_reference.AwardID WHERE award_program_reference.AwardID = %s LIMIT 1", (award_id,))
...
#-------------------------------------                     
                    ...
                    if result:
                        ...
                        cursor.execute("INSERT INTO info (AwardID, MinAmdLetterDate, MaxAmdLetterDate, AwardEffectiveDate, AwardExpirationDate, AwardTotalIntnAmount, \
                        AwardAmount, AbstractNarration, First_Investigator, Second_Investigator, SignBlockName, Name) SELECT award.AwardID, award.MinAmdLetterDate, \
                        award.MaxAmdLetterDate, award.AwardEffectiveDate, award.AwardExpirationDate, award.AwardTotalIntnAmount, award.AwardAmount, award.AbstractNarration, \
                        concat(investigator.FirstName,' ', investigator.LastName) as First_Investigator, concat(investigator.FirstName2,' ', investigator.LastName2) as Second_Investigator , \
                        program_officer.SignBlockName, institution.Name FROM award JOIN investigator ON award.AwardID =investigator.AwardID JOIN program_officer \
                        ON investigator.AwardID=program_officer.AwardID JOIN institution ON program_officer.AwardID = institution.AwardID WHERE award.AwardID = %s", (award_id,))
